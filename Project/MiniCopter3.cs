...
namespace Project
{
    public class MiniCopter3 : Enemy
    {
        ...
        public MiniCopter3(ContentManager content, Vector2 position, Random random)
        ...
        {
            var projectile = new MiniCopterBullet(GameState3.Instance.ContentManager, new Vector2(Position.X, Position.Y + 10));
            GameState3.Instance.AddEnemyBullet(projectile);
        }
